...
<style lang="postcss">
	.tooltip {
		--border-size: 1px;
		@apply fixed bg-neutral-800 text-white dynadark:bg-neutral-200 dynadark:text-black border border-stone-400 dynadark:border-white drop-shadow-lg text-xs rounded-lg pointer-events-none z-[999] max-w-xs break-words whitespace-normal backdrop-blur-none backdrop-saturate-100;
